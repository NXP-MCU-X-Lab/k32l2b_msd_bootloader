...
static const uint32_t disc_size = KB(128-32+28);
...
static uint32_t read_file_firmware(uint32_t sector_offset, uint8_t *data, uint32_t num_sectors)
{
    memcpy(data, (void*)(DAPLINK_ROM_IF_START + sector_offset*512), 512);
    return 512;
}
